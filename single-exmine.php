	...
	?>
		<div class="main-page">
			<div style="background-color: #fff;" class="sub-page">
				<table style="background-color: #fff;" class="exmine">
					<tbody>
						<tr>
						...
						<tr></tr>
						<tr>
							<td class="no-border" style="height: 90px;vertical-align: baseline;" colspan="3">امضاء مدیر فنی آزمایشگاه</td>
							<td class="no-border" style="height: 90px;vertical-align: baseline;" colspan="3">مهر آزمایشگاه</td>
							<td class="no-border" style="height: 90px;vertical-align: baseline;" colspan="4">مهر برجسته آزمایشگاه</td>
						</tr>
